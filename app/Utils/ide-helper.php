 ...
 *                               arrays. When false, JSON objects will be returned as
 *                               objects.
 * @param  int     $depth        the maximum nesting depth of the structure being
 *                               decoded.
 *
 ...
 */
function simdjson_decode(string $json, bool $associative = false, int $depth = 512): float|int|bool|array|string|stdClass|null { }
 ...
 * @param  int     $depth                 The maximum nesting depth of the structure
 *                                        being decoded.
 * @param  bool    $throw_if_uncountable  If true, then throw SimdJsonException instead
 *                                        of
 ...
 * @see https://www.rfc-editor.org/rfc/rfc6901.html
 */
function simdjson_key_value(string $json, string $key, bool $associative = false, int $depth = 512): float|int|bool|array|string|stdClass|null { }
